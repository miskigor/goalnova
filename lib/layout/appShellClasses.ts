...
export const APP_MOBILE_BOTTOM_NAV_MOUNT_CLASS = [
  "pointer-events-none visible fixed inset-x-0 bottom-0 z-[9999] box-border w-auto max-w-full min-w-0",
  "overflow-x-hidden overflow-y-visible opacity-100 max-lg:block lg:hidden",
].join(" ");
