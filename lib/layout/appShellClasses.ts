...
export const APP_SHELL_MAIN_CLASS = [
  "mx-auto box-border flex w-full min-w-0 max-w-full flex-1 flex-col items-stretch px-4",
...
export const APP_MOBILE_BOTTOM_NAV_CLASS = [
  "fixed bottom-0 left-0 right-0 z-[60] box-border flex w-full max-w-full min-w-0",
