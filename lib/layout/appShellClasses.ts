...
export const APP_SHELL_ROOT_CLASS =
  "relative mx-auto box-border flex min-h-dvh min-w-0 w-full max-w-full overflow-x-clip bg-gn-bg text-gn-text max-lg:flex-col lg:flex-row";

export const APP_SHELL_COLUMN_CLASS =
  "relative mx-auto box-border flex min-h-dvh min-h-0 min-w-0 w-full max-w-full flex-1 flex-col overflow-x-clip ps-0 lg:ps-[15.5rem]";
...
export const APP_MOBILE_HEADER_CLASS = [
  "fixed inset-x-0 top-0 z-[55] box-border w-full max-w-full shrink-0 overflow-x-hidden",
...
export const APP_MOBILE_BOTTOM_NAV_CLASS = [
  "pointer-events-none fixed inset-x-0 bottom-0 z-[60] box-border w-full max-w-full min-w-0 overflow-x-hidden",
