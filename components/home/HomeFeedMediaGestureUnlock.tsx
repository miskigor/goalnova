...
export function HomeFeedMediaGestureUnlock() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-[var(--gn-app-header-offset)] bottom-[var(--gn-app-bottom-nav-offset)] z-[45] flex items-center justify-center p-6 lg:inset-0">
      <button
        type="button"
