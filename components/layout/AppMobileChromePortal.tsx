  ...
  return createPortal(
    <>
      <div
        ...
        className="pointer-events-auto fixed inset-x-0 top-0 z-[600] translate-z-0 max-lg:block lg:hidden"
      >
        <AppMobileHeader />
      </div>
      <div
        ...
        className="pointer-events-auto fixed inset-x-0 bottom-0 z-[600] translate-z-0 max-lg:block lg:hidden"
      >
        <AppMobileBottomNav />
      </div>
    </>,
