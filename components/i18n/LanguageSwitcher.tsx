...
const landingSelect =
  "mx-auto block w-full max-w-[11rem] cursor-pointer rounded-full border border-white/10 bg-black/30 py-1.5 ps-3 pe-3 text-[11px] font-medium text-gn-text outline-none backdrop-blur-md transition-[border-color,background-color,color] hover:border-white/18 hover:bg-white/[0.06] hover:text-gn-text focus-visible:ring-2 focus-visible:ring-gn-accent/50 [text-align-last:center] sm:max-w-[10rem] sm:text-xs";
