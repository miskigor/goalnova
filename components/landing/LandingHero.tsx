...
export function LandingHero({
  ...
  return (
    <section
      data-landing-hero
      className="relative box-border w-full min-w-0 max-w-full overflow-x-clip px-4 pb-8 pt-6 sm:px-6 sm:pb-14 sm:pt-14"
    >
      <div
        ...
        aria-hidden
      />
      <div className="mx-auto grid w-full min-w-0 max-w-6xl gap-8 sm:gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,340px)] lg:items-center lg:gap-12">
        <div className="min-w-0 text-center lg:text-left">
          ...
          <div className="mt-6 flex w-full min-w-0 max-w-full flex-col items-stretch gap-3 sm:mt-8 sm:flex-row sm:justify-center lg:justify-start">
            <a
              href={signupHref}
