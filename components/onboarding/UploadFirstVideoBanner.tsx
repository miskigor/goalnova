    ...
    <section
      ...
      className={[
        ...
        isCompact
          ...
          : "p-4 shadow-[0_12px_40px_-16px_rgba(249,115,22,0.35)] max-lg:rounded-lg max-lg:p-1.5 sm:p-5",
      ].join(" ")}
    >
      <h2
        ...
        className={[
          ...
          isCompact ? "text-sm" : "text-base max-lg:text-xs sm:text-lg",
        ].join(" ")}
      >
        {t("uploadFirstTitle")}
      </h2>
      ...
      <div
        className={[
          ...
          isCompact ? "" : "max-lg:mt-1.5 max-lg:gap-1",
        ].join(" ")}
      >
        <Link
          href="/upload"
          className={`${GN_PRIMARY_BUTTON_CLASS} ${buttonClass} ${isCompact ? "" : "max-lg:min-h-7 max-lg:rounded-lg max-lg:!py-1 max-lg:text-xs"}`}
        >
          {t("uploadFirstCta")}
        </Link>
        <button
          type="button"
          onClick={onLater}
          className={`${GN_SECONDARY_BUTTON_CLASS} ${buttonClass} ${isCompact ? "" : "max-lg:min-h-7 max-lg:rounded-lg max-lg:!py-1 max-lg:text-xs"}`}
        >
          {t("uploadFirstLater")}
        </button>
      </div>
