...
-- Platform staff must not get every club on their player profile / "your club" list.
-- Staff can still open a specific club dashboard (goalnova_club_user_can_manage keeps the staff bypass).
